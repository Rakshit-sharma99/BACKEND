...
router.post("/getEventsByFilters", getEventsByFilters)
...
router.post("/updateEventExtraFields", updateEventExtraFields)
router.post("/updateTicketTypeExtraFields", updateTicketTypeExtraFields)
