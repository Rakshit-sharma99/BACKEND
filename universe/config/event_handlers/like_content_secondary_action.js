...
const like_content_secondary_action = async (messageValue) => {
  try {
    ...
    console.error("❌ like_content_secondary_action failed", error);
  }
};

module.exports = { like_content_secondary_action };
